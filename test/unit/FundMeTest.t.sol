...
contract FundMeTest is Test{
    ...
    function testFundUpdatesFundedDataStructure() public {
        vm.prank(USER); // The nest TX will be sen by USER
    ...
    function testWithdrawFromMutilpleFunders() public funded {
        // Arrange
    ...
    function testWithdrawFromMutilpleFundersCheaper() public funded {
        // Arrange
        uint160 numberOfFunders = 10;
        uint160 startingFunderIndex = 1;
